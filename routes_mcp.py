...
def confirm_booking(booking_id: str, account_id: str) -> dict:
    """ยืนยันการจอง ตัดเงิน พร้อมสร้างตั๋วที่นั่ง (Ticket)"""
...
@mcp.tool()
def get_goods_by_cineplex(cineplex_id: str) -> dict:
    """แสดงรายการสินค้าขนม/เครื่องดื่มในสาขานั้นๆ"""
...
def order_goods(user_id: str, cineplex_id: str, items_dict: dict, account_id: str, coupon_id: str = None) -> dict:
    """สั่งซื้อขนม/น้ำ แจ้งราคาปกติ/ส่วนลด และการชำระเงิน"""
...
def upgrade_member(user_id: str, account_id: str) -> dict:
    """สมัคร/ต่ออายุสมาชิก อัปเกรดอัตโนมัติตามจำนวนครั้ง (150 บาท)"""
